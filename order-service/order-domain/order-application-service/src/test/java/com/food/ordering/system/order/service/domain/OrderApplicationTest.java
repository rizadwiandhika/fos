...
public class OrderApplicationTest {
	...
	private final UUID SAGA_ID = UUID.fromString("00000000-0000-0000-0000-000000000005");
	...
	public void init() {
		...
		when(paymentOutboxRepository.save(any(OrderPaymentOutboxMessage.class))).thenReturn(getPaymentOutboxMessage());
	}
	...
	private OrderPaymentOutboxMessage getPaymentOutboxMessage() {
